...
function Viewer() {
  ...
  const sampleImages = [
    ...
    { name: 'Noise Quadrants (RGB)', file: 'viewer/noise_rgb.png' },
    { name: 'Noise Quadrants (Gray)', file: 'viewer/noise_gray.png' },
    { name: 'Noise Quadrants (Bayer)', file: 'viewer/noise_bayer.png' },
    { name: 'Noise Gradient (RGB)', file: 'viewer/noise_gradient_rgb.png' },
    { name: 'Noise Gradient (Gray)', file: 'viewer/noise_gradient_gray.png' },
    { name: 'Noise Gradient (Bayer)', file: 'viewer/noise_gradient_bayer.png' },
